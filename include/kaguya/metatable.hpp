...
#undef KAGUYA_SET_CON_TYPE_DEF
		...
		/// @brief add member property with getter function.(readonly property, experimental)
		/// @param name function name for lua
		...
		/// @brief add member property with setter function.(writeonly property, experimental)
		/// @param name function name for lua
        ...
        /// @brief add member property with external getter function.(readonly property, experimental)
        /// @param name function name for lua
        /// @param getter getter function
        template<typename GetType>
		...
		/// @brief add member property with external setter function.(writeonly property, experimental)
        /// @param name function name for lua
        /// @param setter setter function
        template<typename SetType, typename SetRetType>
